export const en = {
  ...
  journey: {
    ...
    stages: [
      ...
      {
        title: "Growth",
        text: "Mentorship and counseling sharpen her; she learns diligence, wisdom, and a hope that does not waver.",
      },
      {
        title: "Impact",
  ...
  arasProject: {
    ...
    title: "The AraS Project",
    description:
      "AraS Project walks alongside mothers in crisis  women from the street or from any place of hardship  through pregnancy and the newborn season. We help with shelter, clothing, food, and the practical support every new mother needs to care for her child.",
    readMore: "Read Full Story",
    close: "Close",
    ctaText: "Help the AraS Project",
    ctaLink:
      "https://docs.google.com/forms/d/e/1FAIpQLSfyuHw4dbfLVtNi9nl1KbIky7vCcjdFS7-PcLkO0qB06o5o2Q/viewform?usp=dialog",
    modalCta: "Be Part of Her Story",
    stories: [
      {
        id: 1,
        name: "Dagmawit T.",
        location: "Addis Ababa",
        summary:
          "Facing homelessness right after giving birth at 24, Dagmawit received emergency housing, financial support, and baby care supplies through our community.",
        fullStory:
          "At 24 years old and heavily pregnant, Dagmawit was evicted from her home when her husband was suddenly imprisoned following a workplace dispute. With nowhere to turn, she spent her final days of pregnancy living on the streets before giving birth at Ras Desta Hospital.\nRecognizing her urgent situation, our community stepped in securing a safe rental home, paying her rent, and supplying essential food, baby clothes, and post-natal care items.\nToday, Dagmawit and her newborn are safe, warm, and thriving. In her own words: 'God brought people into my life who gave me more than just a roof they gave me peace and restored my hope.'",
      ...
      },
      {
        ...
        location: "Addis Ababa",
        summary:
          "Living on the streets and abandoned during her pregnancy, Sisaynesh was facing deep despair. Through housing, counseling, and holistic support, she found renewed faith and a bright future for her and her child.",
        fullStory:
          "Sisaynesh was living on the streets when she became pregnant. Abandoned by the father of her child, she was left utterly heartbroken and overwhelmed by severe depression, reaching a point of total collapse and hopelessness.\nWhen she had nearly given up, our team stepped in. We secured a safe rental home for her, provided financial assistance, and supplied in-kind necessities for her baby.\nBeyond physical support, we walked alongside her through ongoing counseling—helping her heal, reminding her that this was only the beginning of her story, and guiding her toward a restored future. Today, Sisaynesh has renewed her faith and steps forward with strength and hope for her child.",
  ...
  gallery: {
    ...
    photos: [
      {
        caption: "Visit of the moms around addis ababa during aras Project",
      },
      {
        caption:
          "Mentorship class end picture highlight of the mentorship program",
      },
      {
        caption:
          "Pannel discussion with Dr. Mulat Yohanes on Biblical womanhood: Who is a Woman of virtue? ",
      },
      {
        caption:
          "Holiday home visit during the Christmas season with the moms and their children",
      },
      { caption: "2016 annual lebam set gathering and worship programme" },
      {
        caption:
          "Home visit of the moms and team members holding there Newborn babies ",
      },
      {
        caption:
          "2017 lebam set annual gathering and worship programme organizers group pictures",
      },
      {
        caption:
          "Home visit and prayer time with the moms and their children during aras project visit",
      },
      { caption: "lebam set 2017 picture of the programe" },
      { caption: "Bible study group home program" },
    ],
  },
  team: {
